...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    function RandomMinMax(min,max){
     ...
     const generateFlights = (departureAirportId, arrivalAirportId, duration, flightTypeId) => {
      const randomDate = moment(momentRandom('20231231', '20230101')).format('YYYY-MM-DD')
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.bulkDelete('Flights', null, { truncate: true, cascade: true, restartIdentity: true })
